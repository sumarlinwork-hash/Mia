---
description: ritual wajib
---

WAJIB SELALU:
- fact-cek:
   1. code baca dari line 1 file
   2. - fact cek folder yang bersesuaian dengan masalah yang di address
   3. mempertimbangkan kemampuan device user (lihat DxDiag.txt) saat membuat plan/solusi.
- baca juag file bersesuaian dengan hal yang di address di D:\ProjectBuild\projects\mia\docs
