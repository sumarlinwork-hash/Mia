  ...
  return (
    <Router>
      <div className="relative min-h-screen bg-background overflow-hidden flex">
        ...
        {/* ZEN MODE EXIT OVERLAY: Moved to end of DOM for absolute top-level priority */}
        {isZenMode && (
          <div 
            onClick={() => setIsZenMode(false)}
            className="fixed inset-0 z-[200] cursor-pointer bg-transparent pointer-events-auto"
