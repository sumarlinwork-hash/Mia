  ...
  return (
    <div className="h-6 surface-navigation border-t border-primary/20 flex items-center justify-between px-3 z-30 select-none text-[10px] font-medium text-white/70">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2 px-3 py-0.5 rounded-full bg-white/10 border border-white/10">
        <div className="w-1.5 h-1.5 bg-primary rounded-full motion-ambient" />
        <span className="uppercase tracking-[0.2em] text-[8px] font-black italic text-white/90">MIA KERNEL : SECURE</span>
      </div>
      ...
      <div className="flex items-center gap-4 h-full">
        ...
        <div className={clsx(
          ...
          isSecure ? "bg-primary/10 text-primary" : "bg-red-500/20 text-red-500"
        )}>
          <Lock size={10} />
